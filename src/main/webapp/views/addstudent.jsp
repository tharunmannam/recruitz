...
<div class="testbox">
 ...
 <br>
 <br>
  <form:form method="post" action="/submitstuddata" modelAttribute="stud">
	  <label id="icon" for="name"><i class="icon-user"></i></label>
	  <form:input type="number" path="studId" name="number" id="number" placeholder="Student ID" required="required"/>
	  <br><br>
	  <label id="icon" for="name"><i class="icon-envelope"></i></label>
	  <form:input type="email" path="studEmail" name="email" id="email" placeholder=" Student Email" required="required"/>
	  <br><br>
	  <label id="icon" for="name"><i class="icon-shield"></i></label>
	  <form:input type="password" path="studPassword" name="name" id="name" placeholder="Password" required="required"/>
	   <br>
	   <br>
